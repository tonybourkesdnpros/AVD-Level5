...
| --------- | --------------- | ------------ | --------- |
| pod5 | Vlan4094 | 10.255.252.16 | Port-Channel1 |
...
| Ethernet6 | host2-DC2_Eth3 | *access | *10 | *- | *- | 6 |
| Ethernet7 | host2-DC2_Eth4 | *access | *10 | *- | *- | 6 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_LINK_TO_SPINE1-DC2_Ethernet5 | routed | - | 192.168.103.55/31 | default | 9214 | false | - | - |
| Ethernet4 | P2P_LINK_TO_SPINE2-DC2_Ethernet5 | routed | - | 192.168.103.57/31 | default | 9214 | false | - | - |
| Ethernet5 | P2P_LINK_TO_SPINE3-DC2_Ethernet5 | routed | - | 192.168.103.59/31 | default | 9214 | false | - | - |
...
| 192.168.103.54 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 192.168.103.56 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 192.168.103.58 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
...
| --- | ------------------- | ------------ |
| Red | 192.168.101.10:1000 | connected |
...
router bgp 65202
   ...
   neighbor 192.168.103.54 remote-as 65200
   neighbor 192.168.103.54 description spine1-DC2_Ethernet5
   neighbor 192.168.103.56 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.103.56 remote-as 65200
   neighbor 192.168.103.56 description spine2-DC2_Ethernet5
   neighbor 192.168.103.58 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.103.58 remote-as 65200
