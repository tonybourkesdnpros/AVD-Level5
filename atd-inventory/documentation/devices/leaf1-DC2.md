...
| --------- | --------------- | ------------ | --------- |
| pod4 | Vlan4094 | 10.255.252.13 | Port-Channel1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_LINK_TO_SPINE1-DC2_Ethernet2 | routed | - | 192.168.103.37/31 | default | 9214 | false | - | - |
| Ethernet4 | P2P_LINK_TO_SPINE2-DC2_Ethernet2 | routed | - | 192.168.103.39/31 | default | 9214 | false | - | - |
| Ethernet5 | P2P_LINK_TO_SPINE3-DC2_Ethernet2 | routed | - | 192.168.103.41/31 | default | 9214 | false | - | - |
...
| 192.168.103.36 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 192.168.103.38 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 192.168.103.40 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 10.255.251.13 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Red | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 192.168.101.7:110 | 110:110 | - | - | learned |
| 20 | 192.168.101.7:120 | 120:120 | - | - | learned |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Red | 192.168.101.7:1000 | connected |
...
router bgp 65201
   ...
   neighbor 192.168.103.36 remote-as 65200
   neighbor 192.168.103.36 description spine1-DC2_Ethernet2
   neighbor 192.168.103.38 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.103.38 remote-as 65200
   neighbor 192.168.103.38 description spine2-DC2_Ethernet2
   neighbor 192.168.103.40 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.103.40 remote-as 65200
   neighbor 192.168.103.40 description spine3-DC2_Ethernet2
   redistribute connected route-map RM-CONN-2-BGP
   !
   vlan 10
      rd 192.168.101.7:110
      route-target both 110:110
      redistribute learned
   !
   vlan 20
      rd 192.168.101.7:120
