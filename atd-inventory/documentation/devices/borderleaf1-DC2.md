...
| --------- | --------------- | ------------ | --------- |
| pod6 | Vlan4094 | 10.255.252.21 | Port-Channel1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_LINK_TO_SPINE1-DC2_Ethernet6 | routed | - | 192.168.103.61/31 | default | 9214 | False | - | - |
| Ethernet4 | P2P_LINK_TO_SPINE2-DC2_Ethernet6 | routed | - | 192.168.103.63/31 | default | 9214 | False | - | - |
| Ethernet5 | P2P_LINK_TO_SPINE3-DC2_Ethernet6 | routed | - | 192.168.103.65/31 | default | 9214 | False | - | - |
...
| 192.168.103.60 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 192.168.103.62 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 192.168.103.64 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 10.255.251.21 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Red | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 192.168.101.11:110 | 110:110 | - | - | learned |
| 20 | 192.168.101.11:120 | 120:120 | - | - | learned |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Red | 192.168.101.11:1000 | connected |
...
router bgp 65203
   ...
   neighbor 192.168.103.60 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.103.60 remote-as 65200
   neighbor 192.168.103.60 description spine1-DC2_Ethernet6
   neighbor 192.168.103.62 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.103.62 remote-as 65200
   neighbor 192.168.103.62 description spine2-DC2_Ethernet6
   neighbor 192.168.103.64 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.103.64 remote-as 65200
   neighbor 192.168.103.64 description spine3-DC2_Ethernet6
   redistribute connected route-map RM-CONN-2-BGP
   !
   vlan 10
      rd 192.168.101.11:110
      route-target both 110:110
      redistribute learned
   !
   vlan 20
      rd 192.168.101.11:120
