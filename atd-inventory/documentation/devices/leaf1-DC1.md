...
| Ethernet6 | host1-DC1_Eth1 | *access | *10 | *- | *- | 6 |
| Ethernet7 | host1-DC1_Eth2 | *access | *10 | *- | *- | 6 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_LINK_TO_SPINE1-DC1_Ethernet2 | routed | - | 192.168.103.1/31 | default | 9214 | false | - | - |
| Ethernet4 | P2P_LINK_TO_SPINE2-DC1_Ethernet2 | routed | - | 192.168.103.3/31 | default | 9214 | false | - | - |
| Ethernet5 | P2P_LINK_TO_SPINE3-DC1_Ethernet2 | routed | - | 192.168.103.5/31 | default | 9214 | false | - | - |
...
!
interface Ethernet6
   description host1-DC1_Eth1
   no shutdown
   channel-group 6 mode active
!
interface Ethernet7
   description host1-DC1_Eth2
   no shutdown
   channel-group 6 mode active
```
...
| Port-Channel6 | host1-DC1_Host1-DC1 | switched | access | 10 | - | - | - | - | 6 | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 192.168.101.1:110 | 110:110 | - | - | learned |
| 20 | 192.168.101.1:120 | 120:120 | - | - | learned |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Red | 192.168.101.1:1000 | connected |
...
router bgp 65101
   ...
   !
   vlan 10
      rd 192.168.101.1:110
      route-target both 110:110
      redistribute learned
   !
   vlan 20
      rd 192.168.101.1:120
