...
Et1                            up             up                 MLAG_PEER_leaf1-DC1_Ethernet1
Et2                            up             up                 MLAG_PEER_leaf1-DC1_Ethernet2
Et3                            up             up                 P2P_LINK_TO_SPINE1-DC1_Ethernet3
Et4                            up             up                 P2P_LINK_TO_SPINE2-DC1_Ethernet3
Et5                            up             up                 P2P_LINK_TO_SPINE3-DC1_Ethernet3
Et6                            up             up                 
Et7                            up             up                 
Et15                           up             up                 
...
Ma0                            up             up                 
Po1                            up             up                 MLAG_PEER_leaf1-DC1_Po1
...
--------------- -------------------- ---------- ------------ ---------- -------
Ethernet3       172.31.255.7/31      up         up              9214           
Ethernet4       172.31.255.9/31      up         up              9214           
Ethernet5       172.31.255.11/31     up         up              9214           
Loopback0       192.0.200.4/32       up         up             65535           
Loopback1       192.0.254.3/32       up         up             65535           
Loopback100     10.255.1.4/32        up         up             65535           
Management0     192.168.0.22/24      up         up              1500           
Vlan110         10.1.10.1/24         up         up              1500           
Vlan1199        unassigned           up         up              9164           
Vlan3009        10.255.251.1/31      up         up              9214           
Vlan4093        10.255.251.1/31      up         up              9214           
Vlan4094        10.255.252.1/31      up         up              9214
```
## show lldp neighbors

```
Last table change time   : 0:10:36 ago
...
---------- -------------------------- ---------------------- ---
Et1           leaf1-DC1.atd.lab          Ethernet1           120
Et2           leaf1-DC1.atd.lab          Ethernet2           120
Et3           spine1-DC1.atd.lab         Ethernet3           120
Et4           spine2-DC1.atd.lab         Ethernet3           120
Et5           spine3-DC1.atd.lab         Ethernet3           120
Et6           host1-DC1.arista.lab       Ethernet2           120
Et7           host1-DC1.arista.lab       Ethernet4           120
Et15          OOB-DC1.arista.lab         Ethernet6           120
```
## show running-config

```
! Command: show running-config
! device: leaf2-DC1 (cEOSLab, EOS-4.27.2F-26069621.4272F (engineering build))
!
no aaa root
!
...
Arista cEOSLab
Hardware version: 
Serial number: leaf2-DC1
Hardware MAC address: 001c.73c2.c601
System MAC address: 001c.73c2.c601
