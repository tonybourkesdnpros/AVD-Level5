...
Et1                            up             up                 MLAG_PEER_leaf2-DC1_Ethernet1
Et2                            up             up                 MLAG_PEER_leaf2-DC1_Ethernet2
Et3                            admin down     down               P2P_LINK_TO_SPINE1-DC1_Ethernet2
Et4                            admin down     down               P2P_LINK_TO_SPINE2-DC1_Ethernet2
Et5                            admin down     down               P2P_LINK_TO_SPINE3-DC1_Ethernet2
Et6                            up             up                 
Et7                            up             up                 
Et15                           up             up                 
...
Ma0                            up             up                 
Po1                            up             up                 MLAG_PEER_leaf2-DC1_Po1
Po10                           admin down     down               
...
-------------- ------------------ -------------- ------------ --------- -------
Ethernet3      172.31.255.1/31    admin down     down            9214          
Ethernet4      172.31.255.3/31    admin down     down            9214          
Ethernet5      172.31.255.5/31    admin down     down            9214          
Loopback0      192.0.200.3/32     up             up             65535          
...
Vlan3009       10.255.251.0/31    up             up              9214          
Vlan4093       10.255.251.0/31    up             up              9214          
Vlan4094       10.255.252.0/31    up             up              9214
```
## show lldp neighbors

```
Last table change time   : 0:03:47 ago
...
---------- -------------------------- ---------------------- ---
Et1           leaf2-DC1.atd.lab          Ethernet1           120
Et2           leaf2-DC1.atd.lab          Ethernet2           120
Et6           host1-DC1.arista.lab       Ethernet1           120
Et7           host1-DC1.arista.lab       Ethernet3           120
Et15          OOB-DC1.arista.lab         Ethernet5           120
```
## show running-config

```
! Command: show running-config
! device: leaf1-DC1 (cEOSLab, EOS-4.27.2F-26069621.4272F (engineering build))
!
no aaa root
!
...
router bgp 65101
   ...
   neighbor 172.31.255.0 description spine1-DC1_Ethernet2
   neighbor 172.31.255.2 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.2 remote-as 65001
   neighbor 172.31.255.2 description spine2-DC1_Ethernet2
   neighbor 172.31.255.4 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.4 remote-as 65001
   neighbor 172.31.255.4 description spine3-DC1_Ethernet2
...
Arista cEOSLab
Hardware version: 
Serial number: leaf1-DC1
Hardware MAC address: 001c.73c1.c601
System MAC address: 001c.73c1.c601
