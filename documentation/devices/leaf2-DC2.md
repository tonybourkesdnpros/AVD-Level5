...
| --------- | --------------- | ------------ | --------- |
| mlag4 | Vlan4094 | 10.255.252.12 | Port-Channel1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_LINK_TO_SPINE1-DC2_Ethernet3 | routed | - | 192.168.203.43/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_LINK_TO_SPINE2-DC2_Ethernet3 | routed | - | 192.168.203.45/31 | default | 1500 | False | - | - |
| Ethernet5 | P2P_LINK_TO_SPINE3-DC2_Ethernet3 | routed | - | 192.168.203.47/31 | default | 1500 | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 192.168.201.8/32 |
...
| Vlan3099 |  VRF_1  |  10.255.251.13/31  |  -  |  -  |  -  |  -  |  -  |
...
| 192.168.203.42 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - |
| 192.168.203.44 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - |
| 192.168.203.46 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - |
| 10.255.251.12 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF_1 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 192.168.201.8:10010 | 10010:10010 | - | - | learned |
| 20 | 192.168.201.8:10020 | 10020:10020 | - | - | learned |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| VRF_1 | 192.168.201.8:100 | connected |
...
router bgp 65207
   ...
   neighbor 10.255.251.12 description leaf1-DC2
   ...
   neighbor 192.168.203.42 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.203.42 remote-as 65200
   neighbor 192.168.203.42 description spine1-DC2_Ethernet3
   neighbor 192.168.203.44 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.203.44 remote-as 65200
   neighbor 192.168.203.44 description spine2-DC2_Ethernet3
   neighbor 192.168.203.46 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.203.46 remote-as 65200
   neighbor 192.168.203.46 description spine3-DC2_Ethernet3
   redistribute connected route-map RM-CONN-2-BGP
   !
   vlan 10
      rd 192.168.201.8:10010
      route-target both 10010:10010
      redistribute learned
   !
   vlan 20
      rd 192.168.201.8:10020
