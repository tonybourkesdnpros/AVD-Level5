...
| --------- | --------------- | ------------ | --------- |
| mlag4 | Vlan4094 | 10.255.252.13 | Port-Channel1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_LINK_TO_SPINE1-DC2_Ethernet2 | routed | - | 192.168.203.37/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_LINK_TO_SPINE2-DC2_Ethernet2 | routed | - | 192.168.203.39/31 | default | 1500 | False | - | - |
| Ethernet5 | P2P_LINK_TO_SPINE3-DC2_Ethernet2 | routed | - | 192.168.203.41/31 | default | 1500 | False | - | - |
...
| Vlan3099 |  VRF_1  |  10.255.251.12/31  |  -  |  -  |  -  |  -  |  -  |
...
| 192.168.203.38 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - |
| 192.168.203.40 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - |
| 10.255.251.13 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF_1 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 192.168.201.7:10010 | 10010:10010 | - | - | learned |
| 20 | 192.168.201.7:10020 | 10020:10020 | - | - | learned |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| VRF_1 | 192.168.201.7:100 | connected |
...
router bgp 65207
   ...
   neighbor 10.255.251.13 description leaf2-DC2
   ...
   neighbor 192.168.203.36 description spine1-DC2_Ethernet2
   neighbor 192.168.203.38 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.203.38 remote-as 65200
   neighbor 192.168.203.38 description spine2-DC2_Ethernet2
   neighbor 192.168.203.40 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.203.40 remote-as 65200
   neighbor 192.168.203.40 description spine3-DC2_Ethernet2
