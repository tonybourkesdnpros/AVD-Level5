...
| --------- | --------------- | ------------ | --------- |
| mlag6 | Vlan4094 | 10.255.252.20 | Port-Channel1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_LINK_TO_SPINE1-DC2_Ethernet7 | routed | - | 192.168.203.67/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_LINK_TO_SPINE2-DC2_Ethernet7 | routed | - | 192.168.203.69/31 | default | 1500 | False | - | - |
| Ethernet5 | P2P_LINK_TO_SPINE3-DC2_Ethernet7 | routed | - | 192.168.203.71/31 | default | 1500 | False | - | - |
...
| Vlan3099 |  VRF_1  |  10.255.251.21/31  |  -  |  -  |  -  |  -  |  -  |
...
| 192.168.203.66 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - |
| 192.168.203.68 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - |
| 192.168.203.70 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - |
| 10.255.251.20 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF_1 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 192.168.201.12:10010 | 10010:10010 | - | - | learned |
| 20 | 192.168.201.12:10020 | 10020:10020 | - | - | learned |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| VRF_1 | 192.168.201.12:100 | connected |
...
router bgp 65203
   ...
   neighbor 192.168.203.66 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.203.66 remote-as 65200
   neighbor 192.168.203.66 description spine1-DC2_Ethernet7
   neighbor 192.168.203.68 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.203.68 remote-as 65200
   neighbor 192.168.203.68 description spine2-DC2_Ethernet7
   neighbor 192.168.203.70 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.203.70 remote-as 65200
   neighbor 192.168.203.70 description spine3-DC2_Ethernet7
