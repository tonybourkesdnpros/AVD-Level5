...
| --------- | --------------- | ------------ | --------- |
| mlag3 | Vlan4094 | 10.255.252.9 | Port-Channel1 |
...
| Vlan3099 |  VRF_1  |  10.255.251.8/31  |  -  |  -  |  -  |  -  |  -  |
...
| 10.255.251.9 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF_1 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - |
...
| 20 | 192.168.101.5:10020 | 10020:10020 | - | - | learned |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| VRF_1 | 192.168.101.5:100 | connected |
